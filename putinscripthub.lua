...
AnnouncementGUI.Name = "AnnouncementWindow"
AnnouncementGUI.ResetOnSpawn = false
AnnouncementGUI.Parent = PlayerGui

-- 主窗口框架
local MainFrame = Instance.new("Frame")
MainFrame.Size = UDim2.new(0.5, 0, 0.6, 0) -- 占屏幕50%宽度和60%高度
MainFrame.Position = UDim2.new(0.5, 0, 0.5, 0)
MainFrame.AnchorPoint = Vector2.new(0.5, 0.5) -- 居中定位
...
AnnouncementBox.Name = "AnnouncementInput"
AnnouncementBox.Size = UDim2.new(0.9, 0, 0.7, 0) -- 占主框架90%宽度和70%高度
AnnouncementBox.Position = UDim2.new(0.05, 0, 0.15, 0) -- 顶部留出标题空间
AnnouncementBox.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
AnnouncementBox.TextColor3 = Color3.fromRGB(200, 200, 200)
AnnouncementBox.Font = Enum.Font.Gotham
AnnouncementBox.TextSize = 14
AnnouncementBox.TextWrapped = true -- 自动换行
AnnouncementBox.MultiLine = true -- 允许多行输入
AnnouncementBox.PlaceholderText = "普京脚本V0.1版，添加了通用脚本和slap battles的脚本"
AnnouncementBox.Parent = MainFrame

-- 输入框圆角效果
local InputCorner = Instance.new("UICorner")
InputCorner.CornerRadius = UDim.new(0.03, 0)
InputCorner.Parent = AnnouncementBox

-- =============== 关闭按钮 =============== --
local CloseButton = Instance.new("TextButton")
CloseButton.Name = "CloseButton"
CloseButton.Size = UDim2.new(0.08, 0, 0.1, 0) -- 占主框架8%宽度和10%高度
CloseButton.Position = UDim2.new(0.9, 0, 0.02, 0) -- 右上角
CloseButton.Text = "×"
...
CloseButton.MouseButton1Click:Connect(function()
    AnnouncementGUI.Enabled = false -- 隐藏整个GUI
    -- 如果需要完全销毁请使用: AnnouncementGUI:Destroy()
end)
